...
// // ─── Tipos ────────────────────────────────────────────────────────────────────
// import type { CommentColor, Comentario, HoraData, ProduccionHoraListProps } from "@/Features/types";

// // ─── Config de colores para ondas ─────────────────────────────────────────────
...
//   return (
//     <div className="flex items-center gap-2 shrink-0 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-100">
//       <button
//         onClick={() => setOpen((v) => !v)}
...
//           <svg width="60" height="10" viewBox="0 0 80 12">
...
// // ─── Fila de una hora (Estilo Píldora) ────────────────────────────────────────

// function HoraRow({ item, acumulado, index }: { item: HoraData; acumulado: number; index: number }) {
//   const comentariosValidos = (item.comentarios ?? []).filter(c => c.contenido?.trim());

//   return (
//     <div className="flex items-center bg-white rounded-[40px] p-2 pr-6 shadow-sm border border-gray-100 mb-3 min-h-[80px] transition-all hover:shadow-md">
      
//       {/* Sección Izquierda: Icono y Hora (Copiado de la imagen) */}
//       <div className="flex items-center gap-4 min-w-[240px] px-2">
//         <div className="bg-[#004B23] w-14 h-14 rounded-[20px] flex items-center justify-center shrink-0 shadow-inner">
//           <Clock size={28} className="text-white" />
//         </div>
//         <div className="flex flex-col">
//           <span className="text-[#004B23] text-[18px] font-bold leading-tight tracking-tight">
//             HORA {item.hora}
//           </span>
...
//         <div className="flex flex-col">
//           <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider">PH Producidos</span>
//           <div className="flex items-baseline gap-1">
//             <span className="text-[22px] font-black text-gray-800 tabular-nums">{item.phProducidos.toFixed(1)}</span>
//             <span className="text-[10px] font-bold text-gray-400">PH</span>
//           </div>
//         </div>

//         <div className="flex flex-col">
//           <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider">Acumulado</span>
//           <div className="flex items-baseline gap-1">
//             <span className="text-[22px] font-black text-[#004B23] tabular-nums">{acumulado.toFixed(1)}</span>
//             <span className="text-[10px] font-bold text-[#004B23]/60">PH</span>
//           </div>
//         </div>
//       </div>

//       {/* Sección de Comentarios */}
//       <div className="flex-1 flex-col justify-end items-center gap-2 overflow-hidden">
//         {comentariosValidos.length > 0 ? (
//           comentariosValidos.map((c, idx) => (
//             <ComentarioItem key={idx} comentario={c} cardIdx={index} commentIdx={idx} />
//           ))
//         ) : (
//           <span className="text-[11px] text-gray-300 italic mr-4">Sin observaciones</span>
//         )}
//       </div>
//     </div>
//   );
...
// export default function ProduccionHoraList({ data }: ProduccionHoraListProps) {
//   let cumulative = 0;
...
// //     phProducidos: 34.5,
// //     comentarios: [
// //       { color: "blue",   contenido: "Arranque normal, sin incidencias." },
// //       { color: "green",  contenido: "Temperatura óptima mantenida." },
// //       { color: "orange", contenido: "" },  // vacío → no se renderiza
// //     ],
// //   },
// //   {
// //     hora: "7:30 – 8:30",
// //     phProducidos: 41.2,
// //     comentarios: [
// //       { color: "blue", contenido: "Ajuste de velocidad de banda." },
// //       { color: "red",  contenido: "Parada 4 min por atasco en empaque." },
// //     ],
// //   },
// // ];
// //
